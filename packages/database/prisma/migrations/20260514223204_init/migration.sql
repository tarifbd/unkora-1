...
-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('BKASH', 'NAGAD', 'ROCKET', 'CARD', 'BANK_TRANSFER', 'COD');
...
-- CreateIndex
CREATE UNIQUE INDEX "book_details_productId_key" ON "book_details"("productId");
...
-- AddForeignKey
ALTER TABLE "book_details" ADD CONSTRAINT "book_details_productId_fkey" FOREIGN KEY ("productId") REFERENCES "products"("id") ON DELETE CASCADE ON UPDATE CASCADE;
